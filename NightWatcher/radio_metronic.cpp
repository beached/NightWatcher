...
// 	daw::radio::radio_write_single_reg( RF1AIFCTL1, 0x74 );   //Radio interface control register 1
// 	daw::radio::radio_write_single_reg( RF1AIFERR, 0x01 );    //Radio interface error flag register
// 	daw::radio::radio_write_single_reg( RF1AIFERRV, 0x02 );   //Radio interface error vector word register
// 	daw::radio::radio_write_single_reg( RF1AINSTRW, 0xC002 ); //Radio instruction word register
// 	daw::radio::radio_write_single_reg( RF1AINSTR1W, 0xC000 );//Radio instruction word register with 1-byte auto-r..
// 	daw::radio::radio_write_single_reg( RF1AINSTR2W, 0xC000 );//Radio instruction word register with 2-byte auto-r..
// 	daw::radio::radio_write_single_reg( RF1ADINW, 0xC002 );   //Radio word data in register
// 	daw::radio::radio_write_single_reg( RF1ASTAT0W, 0x8000 ); //Radio status word register without auto-read
// 	daw::radio::radio_write_single_reg( RF1ASTAT1W, 0x8000 ); //Radio status word register with 1-byte auto-read
// 	daw::radio::radio_write_single_reg( RF1ASTAT2W, 0x8000 ); //Radio status word register with 2-byte auto-read
// 	daw::radio::radio_write_single_reg( RF1AIN, 0x04 );       //Radio core signal input register
// 	daw::radio::radio_write_single_reg( RF1AIFG, 0x3E19 );    //Radio core interrupt flag register
// 	daw::radio::radio_write_single_reg( RF1AIES, 0x200 );     //Radio core interrupt edge select register
// 	daw::radio::radio_write_single_reg( RF1AIE, 0x200 );      //Radio core interrupt enable register
